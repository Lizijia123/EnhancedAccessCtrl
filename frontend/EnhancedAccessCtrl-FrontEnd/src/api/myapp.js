...
export function checkUrlDeployment(url) {
  const data = { address: url }
  return request({
    url: '/api/check-deployment/',
    method: 'post',
    params: {},
    data
  })
...
// 获取检测报告-报告
export function getDetectionReport(app_id) {
  return request({
    url: '/api/v1/detection/report/',
    method: 'get',
    params: { app_id: app_id }
  })
}
...
// 获取检测报告-探测记录
export function getDetectionRecords(query) {
  return request({
    url: '/api/v1/detection/records/',
    method: 'get',
    params: query
  })
}
...
// 获取检测报告-详细探测记录
export function getDetailedDetectionRecords(query) {
  return request({
    url: '/api/detection/traffic-data-list/',
    method: 'get',
    params: query
  })
}
