...
from behavior_agent.brain.Thoughts.LLM import GPTClient, QwenClient, DeepSeekClient, LlamaClient
...
class Brain:
    ...
    def load_knowledge(self):
        """加载知识库"""
        try:
            api_file = f'{dirname(__file__)}/knowledge_base/{self.project_name}_apis.json'
            knowledge_file = f'{dirname(__file__)}/knowledge_base/{self.project_name}_knowledge.json'
