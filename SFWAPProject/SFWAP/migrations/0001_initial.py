...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='SeqOccurTimeFeature',
            fields=[
                ('detectfeature_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='SFWAP.detectfeature')),
                ('string_list', models.JSONField(validators=[SFWAP.models.validate_string_list])),
            ],
            bases=('SFWAP.detectfeature',),
        ),
        migrations.CreateModel(
            name='API',
            fields=[
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('detect_state', models.CharField(choices=[('BASIC_INFO_TO_CONFIGURE', 'BASIC_INFO_TO_CONFIGURE'), ('API_LIST_TO_DISCOVER', 'API_LIST_TO_DISCOVER'), ('API_LIST_TO_IMPROVE', 'API_LIST_TO_IMPROVE'), ('MODEL_FEATURES_TO_CONFIGURE', 'MODEL_FEATURES_TO_IMPROVE'), ('STARTED', 'STARTED'), ('PAUSED', 'PAUSED')], max_length=50)),
