...
from config.basic import BROWSERMOB_PROXY_PATH, EDGE_DRIVER_PATH, CURR_APP_NAME
...
class WebElementCrawler(object):
    ...
    def _log_traffic(self):
        ...
        log_file_path = f'{CURR_APP_NAME}_crawl_log.csv'
    ...
    def _interact_element_and_record_path(self, elem, path):
        try:
            ...
            elem.click()
            with open('web_element_interact_log.txt', 'a') as f:
